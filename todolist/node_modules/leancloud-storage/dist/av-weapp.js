...
var shouldRetry = __webpack_require__(66);
...
var _ = __webpack_require__(0);
var Promise = __webpack_require__(1);
var localStorage = __webpack_require__(51);
...
var CustomEventTarget = __webpack_require__(57);
var EventWrapper = __webpack_require__(58);
...
var _ = __webpack_require__(0);
var cos = __webpack_require__(48);
var qiniu = __webpack_require__(49);
var s3 = __webpack_require__(50);
var AVError = __webpack_require__(4);
...
var parseBase64 = __webpack_require__(52);
...
var AV = __webpack_require__(5);
var AppRouter = __webpack_require__(44);
...
var polyfill = __webpack_require__(43).polyfill;
window = window || {};
polyfill();
polyfill(window);
try {
...
try {
  XMLHttpRequest = XMLHttpRequest || __webpack_require__(17);
} catch (e) {}
try {
  FormData = FormData || __webpack_require__(9);
} catch (e) {}
try {
  WebSocket = WebSocket || __webpack_require__(16);
} catch (e) {}
try {
  navigator = navigator || __webpack_require__(15);
} catch (e) {}
...
var navigator = __webpack_require__(15);
...
AV.Conversation = __webpack_require__(25);
...
var comments = ["Weapp" || 'Node.js'].concat(__webpack_require__(46));
...
module.exports = function upload(uploadInfo, data, file) {
  ...
  return new Promise(function (resolve, reject) {
    var req = request('POST', uploadUrl).set(file._uploadHeaders).field('fileContent', data).field('op', 'upload');
...
module.exports = function upload(uploadInfo, data, file) {
  ...
  return new Promise(function (resolve, reject) {
    var req = request('POST', 'https://up.qbox.me').set(file._uploadHeaders).field('file', data).field('name', file.attributes.name).field('key', file._qiniu_key).field('token', uptoken);
    if (saveOptions.onprogress) {
      req.on('progress', saveOptions.onprogress);
    }
    req.end(function (err, res) {
